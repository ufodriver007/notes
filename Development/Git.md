...
|`git commit --amend -m "Version Modified"`|*внести поправку в предыдущий коммит*
...
Отменить все локальные изменения до последнего коммита и удаление новых, неотслеживаемых файлов и директорий
```bash
git reset --hard
git clean -fd
```
