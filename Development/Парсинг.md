...
- Всегда смортим в документ базовой страницы Network->All ищем там его по типу document или html
...
Распаковываем драйвер рядом со скриптом.
```
...
# пример получения страницы с использованием драйвера Firefox
def get_data_with_selenium(url):
    options = webdriver.FirefoxOptions()
    options.set_preference("general.useragent.override", "User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:109.0) Gecko/20100101 Firefox/109.0")
    serv = Service("/home/ufodriver/PycharmProjects/lessons/geckodriver")
...
>[!tip] Можно скопировать главный GET-запрос как  cURL и в конвертере получить Python код с уже готовыми куками и заголовками
